...
import { ElementsPage, RadioButtons } from '..//..//page-objects/elements_po'
...
When('I navigate to and select {string} from the page menu list', (value) => {
  el.clickTextboxFromMenuList(value)
})
Then('I should be able to see the Radio Button in the header', () => {
  rdo.verifyHeaderValue()
})
When('I click {string} from the list of options that is not disabled', (value) => {
...
When('I click the {string} from the options', (value) => {
